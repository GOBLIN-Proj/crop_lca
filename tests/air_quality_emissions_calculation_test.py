from crop_lca.lca import AirQualityTotals
...
class EmissionsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.crop_emissions_dict = self.airquality.create_emissions_dictionary(
            [self.baseline_index]
        )
    ...
    def test_class(self):
        ...
        self.crop_emissions_dict["soils"][self.baseline_index] += (
            self.airquality.total_soils_NH3_AQ(
        ...
        plt.savefig(os.path.join(path,"airquality_emissions_test.png"))
